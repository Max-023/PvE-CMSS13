...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_MILITIA, SQUAD_MILITIA_2, SQUAD_MILITIA_3, SQUAD_MILITIA_4, SQUAD_MILITIA_5, SQUAD_MILITIA_6))
...
GLOBAL_LIST_INIT(ROLES_UACG, list(JOB_UACG_RIFLE, JOB_UACG_GNR, JOB_UACG_DM, JOB_UACG_TECH, JOB_UACG_MEDIC, JOB_UACG_MEDIC_TRIAGE, JOB_UACG_ARMORY_LACKEY, JOB_UACG_MORTAR, JOB_UACG_LEAD, JOB_UACG_SENLEAD, JOB_UACG_LEAD_FIRE, JOB_UACG_LEAD_MED, JOB_UACG_ARMORY, JOB_UACG_CHAPLAIN, JOB_UACG_OFFICER, JOB_UACG_MESS, JOB_UACG_DOCTOR))
