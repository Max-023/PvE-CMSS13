GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	":m" = RADIO_CHANNEL_MEDSCI, ".m" = RADIO_CHANNEL_USCM_GROUND_MED, "#m" = RADIO_CHANNEL_UPP_MED,
	":n" = RADIO_CHANNEL_ENGI, ".n" = RADIO_CHANNEL_USCM_GROUND_ENGI, "#n" = RADIO_CHANNEL_UPP_ENGI,
	":g" = RADIO_CHANNEL_ALMAYER, ".g" = RADIO_CHANNEL_USCM_GROUND, "#g" = RADIO_CHANNEL_CLF_GEN,
	":v" = RADIO_CHANNEL_COMMAND , ".v" = RADIO_CHANNEL_USCM_GROUND_CMD , "#v" = RADIO_CHANNEL_UPP_CMD,
	...
	":e" = SQUAD_MARINE_5, ".e" = SQUAD_USCM_GROUND_1, "#e" = RADIO_CHANNEL_PMC_ENGI,
	":f" = SQUAD_MARINE_CRYO, ".f" = SQUAD_USCM_GROUND_2, "#f" = RADIO_CHANNEL_PMC_MED,
