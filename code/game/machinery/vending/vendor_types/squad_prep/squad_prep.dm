...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep
	...
	desc = "An automated supply rack hooked up to a small storage of standard marine equipment."
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/uscm_ground/populate_product_list(scale)
	listed_products = list(
		list("STANDARD EQUIPMENT", -1, null, null, null),
		list("Marine Combat Boots", round(scale * 5), /obj/item/clothing/shoes/marine/knife, VENDOR_ITEM_REGULAR),
		list("USCM Uniform", round(scale * 5), /obj/item/clothing/under/marine, VENDOR_ITEM_REGULAR),
		list("Marine Combat Gloves", round(scale * 5), /obj/item/clothing/gloves/marine, VENDOR_ITEM_REGULAR),
		list("M10 Pattern Marine Helmet", round(scale * 10), /obj/item/clothing/head/helmet/marine, VENDOR_ITEM_RECOMMENDED),
		list("Marine Radio Headset", round(scale * 5), /obj/item/device/radio/headset/uscm_ground/marine, VENDOR_ITEM_REGULAR),
		...
		list("M3 Pattern Padded Marine Armor", round(scale * 3), /obj/item/clothing/suit/storage/marine/padded, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Padless Marine Armor", round(scale * 3), /obj/item/clothing/suit/storage/marine/padless, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Ridged Marine Armor", round(scale * 3), /obj/item/clothing/suit/storage/marine/padless_lines, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Skull Marine Armor", round(scale * 3), /obj/item/clothing/suit/storage/marine/skull, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Smooth Marine Armor", round(scale * 3), /obj/item/clothing/suit/storage/marine/smooth, VENDOR_ITEM_REGULAR),
		list("M3-H Pattern Heavy Armor", round(scale * 1), /obj/item/clothing/suit/storage/marine/heavy, VENDOR_ITEM_REGULAR),
		list("M3-L Pattern Light Armor", round(scale * 2), /obj/item/clothing/suit/storage/marine/light, VENDOR_ITEM_REGULAR),

		list("BACKPACK", -1, null, null, null),
		list("Lightweight IMP Backpack", round(scale * 5), /obj/item/storage/backpack/marine, VENDOR_ITEM_REGULAR),
		list("USCM Satchel", round(scale * 5), /obj/item/storage/backpack/marine/satchel, VENDOR_ITEM_REGULAR),
		list("Shotgun Scabbard", round(scale * 2), /obj/item/storage/large_holster/m37, VENDOR_ITEM_REGULAR),

		list("BELTS", -1, null, null),
		list("M276 Pattern Ammo Load Rig", round(scale * 10), /obj/item/storage/belt/marine, VENDOR_ITEM_RECOMMENDED),
		list("M276 Pattern M40 Grenade Rig", round(scale * 3), /obj/item/storage/belt/grenade, VENDOR_ITEM_REGULAR),
		list("M276 Pattern General Pistol Holster Rig", round(scale * 3), /obj/item/storage/belt/gun/m4a3, VENDOR_ITEM_REGULAR),
		list("M276 Pattern M44 Holster Rig", round(scale * 2), /obj/item/storage/belt/gun/m44, VENDOR_ITEM_REGULAR),
		...
		list("POUCHES", -1, null, null, null),
		list("First-Aid Pouch (Splints, Gauze, Ointment)", round(scale * 10), /obj/item/storage/pouch/firstaid/full/alternate, VENDOR_ITEM_RECOMMENDED),
		list("First-Aid Pouch (Pill Packets)", round(scale * 5), /obj/item/storage/pouch/firstaid/full/pills, VENDOR_ITEM_REGULAR),
		list("First-Aid Pouch (Injectors)", round(scale * 2), /obj/item/storage/pouch/firstaid/full, VENDOR_ITEM_REGULAR),
		...
		list("Shotgun Shell Pouch", round(scale * 2), /obj/item/storage/pouch/shotgun, VENDOR_ITEM_REGULAR),
		list("Medium General Pouch", round(scale * 5), /obj/item/storage/pouch/general/medium, VENDOR_ITEM_REGULAR),
		list("Pistol Magazine Pouch", round(scale * 2), /obj/item/storage/pouch/magazine/pistol, VENDOR_ITEM_REGULAR),
		list("Pistol Pouch", round(scale * 2), /obj/item/storage/pouch/pistol, VENDOR_ITEM_REGULAR),

		list("RESTRICTED POUCHES", -1, null, null, null),
		list("Explosive Pouch", round(scale * 1), /obj/item/storage/pouch/explosive, VENDOR_ITEM_REGULAR),
		list("First Responder Pouch (Empty)", round(scale * 1), /obj/item/storage/pouch/first_responder, VENDOR_ITEM_REGULAR),
		list("Large Pistol Magazine Pouch", round(scale * 1), /obj/item/storage/pouch/magazine/pistol/large, VENDOR_ITEM_REGULAR),
		list("Tools Pouch", round(scale * 1), /obj/item/storage/pouch/tools, VENDOR_ITEM_REGULAR),
		list("Sling Pouch", round(scale * 1), /obj/item/storage/pouch/sling, VENDOR_ITEM_REGULAR),

		list("MASK", -1, null, null, null),
		list("Gas Mask", round(scale * 5), /obj/item/clothing/mask/gas, VENDOR_ITEM_REGULAR),

		list("MISCELLANEOUS", -1, null, null, null),
		list("Ballistic goggles", round(scale * 3), /obj/item/clothing/glasses/mgoggles, VENDOR_ITEM_REGULAR),
		list("M1A1 Ballistic goggles", round(scale * 3), /obj/item/clothing/glasses/mgoggles/v2, VENDOR_ITEM_REGULAR),
		list("Prescription ballistic goggles", round(scale * 3), /obj/item/clothing/glasses/mgoggles/prescription, VENDOR_ITEM_REGULAR),
		list("Marine RPG glasses", round(scale * 3), /obj/item/clothing/glasses/regular, VENDOR_ITEM_REGULAR),
		list("M5 Integrated Gas Mask", round(scale * 3), /obj/item/prop/helmetgarb/helmet_gasmask, VENDOR_ITEM_REGULAR),
		...
		list("Firearm Lubricant", round(scale * 5), /obj/item/prop/helmetgarb/gunoil, VENDOR_ITEM_REGULAR),
		list("USCM Flair", round(scale * 5), /obj/item/prop/helmetgarb/flair_uscm, VENDOR_ITEM_REGULAR),
		list("USCM Shoulder Patch", round(scale * 5), /obj/item/clothing/accessory/patch, VENDOR_ITEM_REGULAR),
		list("Bedroll", round(scale * 3), /obj/item/roller/bedroll, VENDOR_ITEM_REGULAR),
		)


/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/upp
	name = "\improper UnTech Surplus Equipment Vendor"
	desc = "An automated supply rack hooked up to a small storage of standard UPP equipment."
	icon_state = "upp_gear"
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad/uscm_ground
	req_access = list(ACCESS_USCM_GROUND_GENERAL)
	req_one_access = null

/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad/uscm_ground/populate_product_list(scale)
	listed_products = list(
		list("FOOD", -1, null, null),
		...
		list("TOOLS", -1, null, null),
		list("Entrenching Tool (ET)", round(scale * 5), /obj/item/tool/shovel/etool/folded, VENDOR_ITEM_REGULAR),
		list("Screwdriver", round(scale * 2), /obj/item/tool/screwdriver, VENDOR_ITEM_REGULAR),
		list("Wirecutters", round(scale * 2), /obj/item/tool/wirecutters, VENDOR_ITEM_REGULAR),
		list("Crowbar", round(scale * 2), /obj/item/tool/crowbar, VENDOR_ITEM_REGULAR),
		list("Wrench", round(scale * 2), /obj/item/tool/wrench, VENDOR_ITEM_REGULAR),
		list("Multitool", round(scale * 1), /obj/item/device/multitool, VENDOR_ITEM_REGULAR),
		list("Welding Tool", round(scale * 1), /obj/item/tool/weldingtool, VENDOR_ITEM_REGULAR),
		...
		list("VP78 magazine (9mm)", round(scale * 10), /obj/item/ammo_magazine/pistol/vp78, VENDOR_ITEM_REGULAR),
